defmodule Web.RoomChannel_copy do
  @moduledoc """
  ...
  def join("room:" <> room_name, _params, socket) do
    ...
    IO.inspect(tx_id, label: :riki_join)
  ...
  def handle_in("candidate", candidate, socket) do
    ...
    IO.inspect(tx_id, label: :riki_handle_candidate)
  ...
  def handle_in("offer", offer, socket) do
    ...
    IO.inspect(tx_id, label: :riki_handle_offer)
  ...
  def handle_info(:join_janus_room, socket) do
    IO.inspect("handle joinroom", label: :riki_handle_join_janus_room)
  ...
  def handle_info({:janus_ws, msg}, socket) do
    IO.inspect("handle janus ws", label: :riki_handle_msg)
